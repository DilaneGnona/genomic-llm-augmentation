...
# Configuration for Minimax random forest model
CONFIG = {
    "DATASET": "pepper",
    "OVERWRITE_PREVIOUS": True,
    "RANDOM_SEED": 42,
    "OUTDIR": "03_modeling_results/pepper_augmented/minimax",
    "PROCESSED": "02_processed_data/pepper",
    "AUGMENTED": "04_augmentation/pepper/minimax",
    "SYNTHETIC_Y": "filtered_synthetic_y.csv",
    "OUTER_CV_FOLDS": 2,
    "INNER_CV_FOLDS": 2,
    "MAX_FEATURES": 2000,
    "TARGET_COLUMN": "Yield_BV",
    "MODEL_NAME": "random_forest_minimax"
}
...
logging.info("Starting Minimax Random Forest Modeling Pipeline")
...
def load_data():
    ...
    logging.info(f"Minimax synthetic y shape: {synthetic_y.shape}")
    
    # Get numeric SNP columns (exclude Sample_ID)
    real_X_numeric = real_X[snp_columns]
